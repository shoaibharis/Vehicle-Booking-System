   ...
   if($passwordConfirm ==''){
        ...
        if($password != $passwordConfirm){
         ...
         if(strlen($password)>20){ // Max 
          ...
          $sql="select * from adminrecord where (username='$username' or email='$email');";
...
$row = mysqli_fetch_assoc($res);
   ...
   // $password = password_hash($password,PASSWORD_BCRYPT,$options);
            ...
            $result = mysqli_query($dbc,"INSERT into adminrecord(fname,lname,username,email,password) values('$fname','$lname','$username','$email','$password')");
