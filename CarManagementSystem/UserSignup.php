...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
     ...
     <div class="col-sm-4">
      <img src="https://www.pngarts.com/files/5/Sign-Up-Button-Transparent-Images.png" alt="Techno Smarter" class="logo img-fluid"> 
    </div>
     <div class="col-sm-4">
    </div>
  </div>
   ...
   if($passwordConfirm ==''){
        ...
        if($password != $passwordConfirm){
         ...
         if(strlen($password)>20){ // Max 
          ...
          $sql="select * from userrecord where (username='$username' or email='$email');";
...
$row = mysqli_fetch_assoc($res);
 ...
 //   $password = password_hash($password,PASSWORD_BCRYPT,$options);
            ...
            $result = mysqli_query($dbc,"INSERT into userrecord(fname,lname,username,email,password) values('$fname','$lname','$username','$email','$password')");
...
?>
      ...
      <?php if(isset($done)) 
      { ?>
    <div class="successmsg"><span style="font-size:100px;">&#9989;</span> <br> You have registered successfully . <br> <a href="UserLogin.php" style="color:#fff;">Login here... </a> </div>
      <?php } else { ?>
...
<div class="form-group">
  ...
  <button type="submit" name="signup" class="btn btn-primary btn-group-lg form_btn">SignUp</button>
   <p>Have an account?  <a href="UserLogin.php">Log in</a> </p>
</form>
<?php } ?> 
</div>
		</div>
